    ...
    <body>
        <div class='md-5 login-container'>
            <form method='post' class='login-form' action='action_login.php'>
                ...
                <div class='mb-3 row'>
                    <button type='submit' name='login' value='1' class='btn btn-info btn-sm'> Login
                        <span class='glyphicon glyphicon-log-in'></span>
                    </button>

                    <div class='empty-span-m'></div>
                    
                    <button type='submit' name='toregister' value='0' class='btn btn-info btn-sm' onclick='removeRequiredAttributes()'> Register
