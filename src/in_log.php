...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            if (isset($x)) {
                $stmt = $conn->prepare("SELECT * FROM logger WHERE `logging` = 'In' AND part_name LIKE '$x';");
            } 
            elseif(isset($category)){
                $stmt = $conn->prepare("SELECT * FROM logger WHERE `logging` = 'In' AND category = '$category';");
            }
            else{
                $stmt = $conn->prepare("SELECT * FROM logger WHERE `logging` = 'In';");
            }
            $stmt->execute();
